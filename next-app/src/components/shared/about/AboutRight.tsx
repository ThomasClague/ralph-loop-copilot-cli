...
/**
 * About section with image on the right and text content on the left.
 * On mobile, stacks vertically (content above image).
 */
export function AboutRight({ content, business }: AboutRightProps) {
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 md:grid-cols-2">
        {/* Content column — left (renders first in DOM for mobile) */}
